...
<div class="message-box">
	<h1 style="font-family:'Organo'">404</h1>
	<p style="font-family:'OpenSans-Regular'">Page not found</p>
	<div class="buttons-con">
		<div class="action-link-wrap">
			<a v-on:click="$router.back()" style="font-family:'OpenSans-Regular'" class="link-button link-back-button">Go Back</a>
			<a v-on:click="$router.push('/')" style="font-family:'OpenSans-Regular'" class="link-button">Go to Home Page</a>
		</div>
	</div>
</div>
	<!-- <img style="height: 500px;" src="/src/assets/images/pharmacy/013-pharmacy-2.svg">
	<span>404</span> -->
</div>
</template>
<script>
